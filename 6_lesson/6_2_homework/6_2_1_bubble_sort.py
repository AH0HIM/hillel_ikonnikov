"""
1. Вам дан код сортировки пузырьком, однако он работает неверно, там допущена ошибка. Используя дебагер, найдите и
...
def bubble_sort(l):
    ...
    #             t[i], t[n] = t[n], t[i]   # неправильная перестановка соседнего элемента
